...
FILES="App.js app.json assets/dots-logo-white.png components/icons.js components/ui.js lib/format.js lib/push.js lib/pushModule.js lib/supabase.js lib/theme.js screens/AccountScreen.js screens/DriverHomeScreen.js screens/LoginScreen.js screens/TripsScreen.js screens/WalletScreen.js tasks/locationTask.js"
