...
FILES="App.js app.json assets/dots-logo-white.png components/DestinationPicker.js components/DestinationPicker.web.js components/DriverMap.js components/DriverMap.web.js components/icons.js components/ui.js lib/format.js lib/geocoding.js lib/notifications.js lib/pushModule.js lib/supabase.js lib/theme.js screens/AccountScreen.js screens/LoginScreen.js screens/RiderHomeScreen.js screens/TripsScreen.js assets/fonts/NunitoSans-Regular.ttf assets/fonts/NunitoSans-SemiBold.ttf assets/fonts/NunitoSans-Bold.ttf assets/fonts/NunitoSans-ExtraBold.ttf lib/fonts.js package.json components/SearchingMap.js components/DriverCard.js"
